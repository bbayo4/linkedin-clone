...
export const Container = styled.div`
  ...
  .profile-cover {
    width: 100%;
    height: 54px;
    background: url('https://media-exp1.licdn.com/dms/image/C4D16AQG8M6DHDLLm3A/profile-displaybackgroundimage-shrink_350_1400/0?e=1611187200&v=beta&t=VYVKnddbWMhAUpnX0kBApRztxJjFIZHseKiIo2TtzOw');
